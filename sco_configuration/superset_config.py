...
#AUTH_TYPE = AUTH_DB #uncomment only if you need to access Superset as the default admin user
...
PROVIDER_ROLE = 'ROLE_PROVIDER'

OAUTH_PROVIDERS = [
    {'name': 'aac', 'icon': 'fa-google', 'token_key': 'access_token',
        'remote_app': {
            'consumer_key': '', #add your consumer key/client ID
